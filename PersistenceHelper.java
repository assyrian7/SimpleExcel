...
/*
 * This class is in charge of handling saving and loading.
 */

public class PersistenceHelper {
	
	/*
	 * The save method stores the CellMatrix values in the specified file path.
	 */
	...
	/*
	 * The load method recovers CellMatrix values from the specified file path.
	 */
